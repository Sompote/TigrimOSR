...
impl OutputPanel {
    ...
    pub(crate) fn full_path(rel: &str) -> PathBuf {
        ...
        for prefix in &["sandbox", ".", "/tmp/andrewos_sandbox"] {
    ...
    fn pdf_cache_dir() -> PathBuf {
        let dir = std::env::temp_dir().join("andrewos_pdf_pages");
    ...
    fn render_pdf_card(&mut self, ui: &mut egui::Ui, rel_path: &str, border: egui::Color32) {
        ...
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    egui::Frame::new()
                        .fill(egui::Color32::from_rgba_unmultiplied(220, 50, 50, 25))
                        .corner_radius(6.0)
    ...
    fn render_excel_card(&mut self, ui: &mut egui::Ui, rel_path: &str, border: egui::Color32) {
        ...
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ui.horizontal(|ui| {
                    egui::Frame::new()
                        .fill(egui::Color32::from_rgba_unmultiplied(34, 139, 34, 25))
                        .corner_radius(6.0)
                        .inner_margin(egui::Margin::symmetric(6, 4))
                        .show(ui, |ui| {
                            ui.label(
